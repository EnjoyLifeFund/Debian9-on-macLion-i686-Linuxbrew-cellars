...
"i686-linux-thread-multi-4.9.0-3-686-pae" or
	die "Errno architecture (i686-linux-thread-multi-4.9.0-3-686-pae) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
